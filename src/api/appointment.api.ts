...
export async function createAppointment(ctx: TeddyRequestContext) {
  ...
  const { client_profile_id, datetime_local, duration_minutes, summary } = ctx
    .request.body as AppointmentCreationAttributes;
  ...
  console.log(datetime_utc);
  console.log(datetime_local.substring(0, 24));
