...
export class AppointmentAPI {
  ...
  public static async createAppointment(ctx: AuthenticatedRequestContext) {
    ...
    kirk.info('apiAppointment_create', {
      override_warnings,
    ...
    const appointment = await createAppointmentForClient(
      override_warnings,
      service_provider_user_id,
      client_profile_id,
      datetime_local,
    ...
    kirk.info('New appointment created', {
      appointment_id,
    });

    await issueClientConfirmationRequest(
      ctx.user,
