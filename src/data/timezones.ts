...
export const timezones_by_utc_string: Record<string, StaticTimezone> = {};

const timezones_raw = timezones();

for (const zone of timezones_raw) {
  for (const utc_identifier of zone.utc) {
    timezones_by_utc_string[utc_identifier] = zone;
  }
}
